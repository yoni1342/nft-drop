    ...
    <div className = 'flex h-screen flex-col lg:grid lg:grid-cols-10 relative'>
        ...
        <div className ='flex flex-col items-center justify-center py-2 lg:min-h-screen'>
            <div className ='bg-gradient-to-br from-yellow-400 to-purple-600 p-1 rounded-xl dark:bg-gradient-to-br dark:from-yellow-700 dark:to-green-400' >
                <img src="https://links.papareact.com/8sg" alt=""  className ='w-44 rounded-xl object-cover lg:h-96 lg:w-72'/>
            </div>
        <div className = 'space-y-2 p-5 text-center'>
            <h1 className ='text-4xl font-bold text-white dark:text-gray-200' >Yoni Apes</h1>
            <h2 className = 'text-xl text-gray-300'>A collection of yoni Apes who live & breathe React with papafam 🥳 ! </h2>
        </div>
        </div>
        </div>
        {/* Right */}
        ...
        <header className = 'flex items-center justify-between'>
            <h1 className = 'cursor-pointer w-52 text-xl font-extralight sm:w-80'>
                The <Link href = '/'><span className ='font-extrabold underline decoration-pink-600/50 hover:bg-gray-800 hover:p-2 rounded-full'> YONI</span></Link>  NFT Market Place
            </h1>
        ...
        <div className = 'mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:justify-center lg:space-y-0 '>
            ...
            <h1 className = 'text-3xl font-bold lg:text-5xl lg:font-extrabold'>
                The PAPAFAM Ape Coding Clube | NFT Drop
            </h1>
